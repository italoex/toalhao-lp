...
SLOTS = [
    ...
    # --- Quadros do processo (seção "A assinatura") -------------------------
    # Retangulares, ao contrário dos cards: aqui a imagem fica acima do texto,
    # e não atrás dele, então o enquadramento não precisa poupar canto nenhum.
    {
        "nome": "passo-entrega",
        "tipo": "imagem",
        "saida": "passo-entrega.jpg",
        "largura": 1400,
        "altura": 1050,
        "minimo": 800,
        "onde": 'Passo "01 — Entrega" da seção A assinatura',
        "dica": "Deitada, 4:3. O texto entra abaixo da imagem, não por cima.",
    },
    {
        "nome": "passo-uso",
        "tipo": "imagem",
        ...
        "altura": 1050,
        "minimo": 800,
        "onde": 'Passo "02 — Uso" da seção A assinatura',
        "dica": "Deitada, 4:3.",
    },
    {
        "nome": "passo-coleta",
        "tipo": "imagem",
        "saida": "passo-coleta.jpg",
        "largura": 1400,
        "altura": 1050,
        "minimo": 800,
        "onde": 'Passo "03 — Coleta" da seção A assinatura',
        "dica": "Deitada, 4:3.",
    },
    {
        "nome": "passo-ciclo",
        "tipo": "imagem",
        "saida": "passo-ciclo.jpg",
        "largura": 1400,
        "altura": 1050,
        "minimo": 800,
        "onde": 'Passo "04 — Lavagem" da seção A assinatura',
        "dica": "Deitada, 4:3.",
    },
    {
